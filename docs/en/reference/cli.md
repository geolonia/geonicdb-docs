...
geonic me oauth-clients create --name my-ci-bot --scopes read:entities,write:entities

# Create and save credentials for auto-reauth
geonic me oauth-clients create --name my-ci-bot --save

# Create from JSON
geonic me oauth-clients create '{"clientName":"my-bot","allowedScopes":["read:entities"]}'
```
