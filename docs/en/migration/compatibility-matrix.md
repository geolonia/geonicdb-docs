...
outline: deep
---
# GeonicDB vs FIWARE Orion Feature Comparison Table
...
| **Scalability** | Auto-scaling (Lambda) | Manual scaling (containers) |
...
> **※ About csourceSubscriptions**
> Context Source Registration (CSR) subscription functionality is defined in the ETSI GS CIM 009 specification. GeonicDB provides a spec-compliant implementation, but Orion-LD currently does not implement this feature (planned for implementation, see: [Orion-LD Issue #280](https://github.com/FIWARE/context.Orion-LD/issues/280)).
...
| GeoProperty | ✅ | ✅ | Geospatial attributes |
| LanguageProperty | ✅ | ✅ | Multi-language attributes |
| JsonProperty | ✅ | ✅ | JSON value attributes |
| VocabProperty | ✅ | ✅ | Vocabulary attributes (vocab/vocabMap) |
| ListProperty | ✅ | ✅ | List value attributes |
| ListRelationship | ✅ | ✅ | List relationship attributes |
| TemporalProperty | ✅ | ✅ | Temporal attributes |
...
| Exact match (`/path`) | ✅ | ✅ | |
| All descendants search (`/path/#`) | ✅ | ✅ | |
| Direct children search (`/path/+`) | ✅ | ✅ | |
| OR condition (`;`) | ✅ | ✅ | |
| **Pagination** | ✅ | ✅ | |
...
| `values` | ✅ | ✅ | Values only |
| `unique` | ✅ | ✅ | De-duplication when combined with `values` |
