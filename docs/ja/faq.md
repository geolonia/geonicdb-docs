...
**A:** GeonicDB SaaS は AWS 上で稼働しており、Geolonia が完全に管理しています。お客様側でのインストール、インフラ構築、メンテナンスは一切不要です。

### Q: GeonicDB を自社インフラで動かせますか?

**A:** GeonicDB は現在マネージド SaaS サービスのみの提供です。将来的にカスタムデプロイオプションが提供される可能性があります。詳細は [Geolonia にお問い合わせ](https://geolonia.com/contact/)ください。
