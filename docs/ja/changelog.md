...
- **破壊的変更**: NGSIv2 と NGSI-LD のエンティティ分離・仕様準拠 (#966)
  ...
  - NGSIv2 `servicePath` 組み込み属性を追加（`?attrs=servicePath` で取得可能）
...
- Types/Attributes Discovery、Temporal API、Batch Operations の便利メソッドを追加 (#832)
