...
### Fixed
- [fix] cmd_414 — 既存 Glossary 違反 hotfix (geonicdb → GeonicDB): docs/ja/changelog.md + docs/en/changelog.md [Unreleased] セクション修正、fix-doc-quality.ts 再発防止ルール追加 (Closes #198)
